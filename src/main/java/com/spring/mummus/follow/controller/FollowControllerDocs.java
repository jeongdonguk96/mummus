...
interface FollowControllerDocs {
    ...
    CommonResult followPet(@RequestBody FollowPetRequest request);
    ...
    CommonResult unfollowPet(@RequestBody FollowPetRequest request);
    ...
    CommonResult countFollowingPets();
    ...
    CommonResult getFollowerPets(@PathVariable(name = "petId") Long petId);
    ...
    CommonResult countFollowerPets(@PathVariable(name = "petId") Long petId);
